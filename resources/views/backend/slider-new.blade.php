...
@section('content')
    <div class="d-flex justify-content-center flex-nowrap mt-4">
        <div class="col-md-8">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Yeni Slider Ekle</div>
                ...
                <div class="ibox-body" style="">
                    <form   action="{{route('bekci.sliderAdd')}}" enctype="multipart/form-data" method="POST">
                        @CSRF
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editor1" name="name"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <button typeof="submit" class="btn btn-success col-md-12" type="submit">Yeni Slider Ekle</button>
                        </div>
                    </form>
                </div>
            </div>
